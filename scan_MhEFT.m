...
ScanMhEFTMSTB[0, 400];
ScanMhEFTMSTB[0, 800];
ScanMhEFTMSTB[N@Sqrt[6], 400];
ScanMhEFTMSTB[N@Sqrt[6], 800];
...
ScanMhEFTTBMA[N@Sqrt[6], 5000];
ScanMhEFTTBMA[N@Sqrt[6], 10^4];
ScanMhEFTTBMA[N@Sqrt[6], 5 10^4];
...
ScanMhEFTMSMA[N@Sqrt[6], #]& /@ {2, 10, 20, 50};
...
ScanHGMhEFTMSTB[N@Sqrt[6], 400, 2000];
ScanHGMhEFTMSTB[N@Sqrt[6], 800, 2000];
...
ScanHGMhEFTTBMA[N@Sqrt[6], 5000, 2000];
ScanHGMhEFTTBMA[N@Sqrt[6], 10^4, 2000];
ScanHGMhEFTTBMA[N@Sqrt[6], 5 10^4, 2000];
...
ScanHGMhEFTMSMA[N@Sqrt[6], #, 2000]& /@ {2, 10, 20, 50};
...
ScanHGMhEFTMSTB[N@Sqrt[6], 2000, 1000];
ScanHGMhEFTMSTB[N@Sqrt[6], 5000, 1000];
